...
public class MoveTest {
	...
	public static void move(int direction) {
		...
		for(Tuple player: board.getPlayers())
		{
			...
			MoveController.move(board, player.getX(), player.getY(), player.getZ(), direction); // (i+1)%4 car on veut commencer à le faire bouger à droite et non en haut 
			}
	...
	public void moveWithRules() {
		...
		Integer[] direction = {0,2,3,1}; // On fait bouger le joueur dans un certain ordre pour avoir plus de facilité à tester
	...
	public void breakRules() {
		Integer[] direction = {0,3,0,0,1,2}; // On fait bouger le joueur dans un certain ordre pour avoir plus de facilité à tester
