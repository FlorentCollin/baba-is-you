...
public class Editor extends Level {
	...
	public static void loadEditor(String levelName, boolean eraseBoards) {
		...
		String[] imagesToLoad = { "file:ressources" + File.separator + "+.png",
				"file:ressources" + File.separator + "-.png", "file:ressources" + File.separator + "leftArrow.png",
				"file:ressources" + File.separator + "rightArrow.png" };
		...
		/*
		 * Gestionnaire d'évènements pour la souris qui va permettre de sélectionner un
