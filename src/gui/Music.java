...
public class Music extends BabaIsYouApp {
	...
	/**
	 * Le but de cette méthode est de crée un fade dans la musique pour que les
	 * transitions soient plus agréables
	 */
	public void fadeVolume() {
		if (timeline != null)
			timeline.stop(); // Permet de corriger un bug assez spécial qui faisait appel à la fonction
