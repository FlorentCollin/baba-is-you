...
/**
 * Interface qui va gérer les "Vrais" Item (par exemple les Walls, Rocks, Flags,
 * etc,...)
 * 
 */
public abstract class RealItem extends Item {

	private Class<?> typeText; // Variable qui sert à comparer un Item avec sa comparaison en RuleItem (ex:
								// Rock --> TextRock)
	...
	/**
	 * Méthode qui regarde si l'Item correspond à sa comparaison en RuleItem (ex:
	 * Rock == TextRock retourne true)
	 * 
	 * @param wordInRule
	 *            Mot d'une Règle
	 */
