...
/**
 * Sous classe de l'application principale qui va gérer l'affichage des
 * différent(e)s conseils/astuces durant la partie
 *
 */
public class Advice extends BabaIsYouApp {
	...
	private static void initAll() {
		...
		// Ce qui permet de bien repositionner la fenêtre d'astuces lorsque la fenêtre
		// principale est bougée
	...
	/**
	 * Méthode qui va afficher la fenêtre d'astuce dans certains niveaux (ex: la
	 * fenêtre qui s'ouvre quand on joue au niveau 1)
	 * 
	 * @param name
	 *            Le nom de la fenêtre a ouvrir
	 * 
	 */
	public static void loadAdviceStage(String name) {
		...
		gc.drawImage(new Image("file:code" + File.separator + "ressources" + File.separator + "advices" + File.separator + name + ".png"), 0, 0); // Affichage du fond
