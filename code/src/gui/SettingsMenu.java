...
public class SettingsMenu extends Menu {
		...
		menu.setOnKeyPressed(new EventHandler<KeyEvent>() {
			...
			public void handle(KeyEvent event) {
				Image imageToLoad = new Image(
						"file:" + ressourcesPath + "Key_images" + File.separator + event.getCode() + ".png");
	...
	public void setSettingsImages() { // TODO A modifier pour rendre cette méthode modulaire
		upKey.setImage(new Image(
				"file:" + ressourcesPath + "Key_images" + File.separator + settings.getUserSettings().get("up") + ".png"));
		downKey.setImage(new Image(
				"file:" + ressourcesPath + "Key_images" + File.separator + settings.getUserSettings().get("down") + ".png"));
		rightKey.setImage(new Image(
				"file:" + ressourcesPath + "Key_images" + File.separator + settings.getUserSettings().get("right") + ".png"));
		leftKey.setImage(new Image(
				"file:" + ressourcesPath + "Key_images" + File.separator + settings.getUserSettings().get("left") + ".png"));
		restartKey.setImage(new Image(
				"file:" + ressourcesPath + "Key_images" + File.separator + settings.getUserSettings().get("restart") + ".png"));
		saveKey.setImage(new Image(
				"file:" + ressourcesPath + "Key_images" + File.separator + settings.getUserSettings().get("save") + ".png"));
		loadSaveKey.setImage(new Image("file:" + ressourcesPath + "Key_images" + File.separator
				+ settings.getUserSettings().get("load_save") + ".png"));
		nextWorldKey.setImage(new Image("file:" + ressourcesPath + "Key_images" + File.separator
				+ settings.getUserSettings().get("next_world") + ".png"));
		nextWorldModKey.setImage(new Image("file:" + ressourcesPath + "Key_images" + File.separator
				+ settings.getUserSettings().get("next_world_mod") + ".png"));
		previousWorldKey.setImage(new Image("file:" + ressourcesPath + "Key_images" + File.separator
